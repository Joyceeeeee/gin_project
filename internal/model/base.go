...
type BaseModel struct {
	...
	DeletedAt utils.FormatDate `gorm:"column:deleted_at;type:timestamp" json:"deleted_at"`
	IsDel bool `gorm:"column: is_del;type:boolean" json:"is_del"`
}
